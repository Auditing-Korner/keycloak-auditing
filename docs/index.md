...
- **Configuration Audit**: HTTPS, headers, PKCE, redirect URIs, SAML metadata, session cookies
...
- **Real-World Data**: Integrated database of actual Keycloak CVEs (e.g., CVE-2022-1245)
